...
export const webLLMModels: ModelConfig = {
	...
	"DeepSeek-V2-Lite-Chat-q4f32_1-MLC": {
		id: "DeepSeek-V2-Lite-Chat-q4f32_1-MLC",
		matchingModel: "DeepSeek-V2-Lite-Chat-q4f32_1-MLC",
		name: "DeepSeek V2 Lite Chat (Q4F32)",
		description: "DeepSeek's lightweight chat model optimized for web browsers",
		strengths: ["text-generation"],
		provider: "web-llm",
		type: ["text"],
		isFree: true,
	...
	"DeepSeek-R1-Distill-Llama-70B-q4f32_1-MLC": {
		id: "DeepSeek-R1-Distill-Llama-70B-q4f32_1-MLC",
		matchingModel: "DeepSeek-R1-Distill-Llama-70B-q4f32_1-MLC",
		name: "DeepSeek R1 Distill Llama 70B (Q4F32)",
		description: "DeepSeek's R1 model with enhanced reasoning capabilities",
		strengths: ["text-generation", "reasoning"],
		provider: "web-llm",
		type: ["text"],
